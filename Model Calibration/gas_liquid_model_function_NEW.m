function [V1_end, V2_end, V3_end, V4_end, V5_end, V6_end, c3_20_5, c3_20_10, c3_20_15] = gas_liquid_model_function_NEW(T1,k1,k2,k3,k4,k5,k6,Inlet_l2,Inlet_l3,position,td,tf,O2_f)
...
cells_1 = 0; cells_2 = 0; cells_3 = 0; cells_4 = 0; cells_5 = 0; cells_6 = 0; % (=0 for no cells present in well and =1 for cells present)
...
Temp_well1_initial = 24.8 + 273; Temp_well2_initial = 26 + 273; Temp_well3_initial = 29.7 + 273; Temp_well4_initial = 30.4 + 273; Temp_well5_initial = 29.7 + 273; Temp_well6_initial = 30 + 273; % For experimental validation runs
...
for sq = 1:round(s)
    ...
    %% Outputs
    if sq == round(5*60/dt - td/dt)
        if round(position) == 20
            c3_20_5 = c3_20(2)*1e9;
        elseif round(position) == 19
            c3_20_5 = c3_19(2)*1e9;
        elseif round(position) == 18
            c3_20_5 = c3_18(2)*1e9;
        elseif round(position) == 17
            c3_20_5 = c3_17(2)*1e9;
        elseif round(position) == 16
            c3_20_5 = c3_16(2)*1e9;
        elseif round(position) == 15
            c3_20_5 = c3_15(2)*1e9;
        elseif round(position) == 14
            c3_20_5 = c3_14(2)*1e9;
        elseif round(position) == 13
            c3_20_5 = c3_13(2)*1e9;
        elseif round(position) == 12
            c3_20_5 = c3_12(2)*1e9;
        elseif round(position) == 11
            c3_20_5 = c3_11(2)*1e9;
        elseif round(position) == 10
            c3_20_5 = c3_10(2)*1e9;
        else
        end
    elseif sq == round(10*60/dt - td/dt)
        if round(position) == 20
            c3_20_10 = c3_20(2)*1e9;
        elseif round(position) == 19
            c3_20_10 = c3_19(2)*1e9;
        elseif round(position) == 18
            c3_20_10 = c3_18(2)*1e9;
        elseif round(position) == 17
            c3_20_10 = c3_17(2)*1e9;
        elseif round(position) == 16
            c3_20_10 = c3_16(2)*1e9;
        elseif round(position) == 15
            c3_20_10 = c3_15(2)*1e9;
        elseif round(position) == 14
            c3_20_10 = c3_14(2)*1e9;
        elseif round(position) == 13
            c3_20_10 = c3_13(2)*1e9;
        elseif round(position) == 12
            c3_20_10 = c3_12(2)*1e9;
        elseif round(position) == 11
            c3_20_10 = c3_11(2)*1e9;
        elseif round(position) == 10
            c3_20_10 = c3_10(2)*1e9;
        else
        end
    elseif sq == round(15*60/dt - td/dt)
        if round(position) == 20
            c3_20_15 = c3_20(2)*1e9;
        elseif round(position) == 19
            c3_20_15 = c3_19(2)*1e9;
        elseif round(position) == 18
            c3_20_15 = c3_18(2)*1e9;
        elseif round(position) == 17
            c3_20_15 = c3_17(2)*1e9;
        elseif round(position) == 16
            c3_20_15 = c3_16(2)*1e9;
        elseif round(position) == 15
            c3_20_15 = c3_15(2)*1e9;
        elseif round(position) == 14
            c3_20_15 = c3_14(2)*1e9;
        elseif round(position) == 13
            c3_20_15 = c3_13(2)*1e9;
        elseif round(position) == 12
            c3_20_15 = c3_12(2)*1e9;
        elseif round(position) == 11
            c3_20_15 = c3_11(2)*1e9;
        elseif round(position) == 10
            c3_20_15 = c3_10(2)*1e9;
        else
        end
    else
    end
