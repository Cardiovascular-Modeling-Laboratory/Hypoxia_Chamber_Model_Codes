%function [V1_end, V2_end, V3_end, V4_end, V5_end, V6_end, c3_20_5, c3_20_10, c3_20_15, c3_20_20, c3_20_25] = chamber_gas_and_liquid_PAPER(T1,k1,k2,k3,k4,k5,k6,Inlet_l2,Inlet_l3,position,tf,O2_f)
%function [t_total, result, V1_end, V2_end, V3_end, V4_end, V5_end, V6_end] = chamber_gas_and_liquid_PAPER(T1,k1,k2,k3,k4,k5,k6,Inlet_l2,Inlet_l3,position,td,tf,O2_f)
