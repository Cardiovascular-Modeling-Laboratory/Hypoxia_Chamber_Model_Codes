function f = opt_function_primary(k1,k2,k3,k4,k5,k6,Inlet_l2,Inlet_l3,f0,tdur,target_prev,target,target_t,toggle,ic,O2_dir,sol_f_next,T_in,file_path_vel)
...
c2_1 = zeros(1,2); c2_2 = zeros(1,2); c2_3 = zeros(1,2); c2_4 = zeros(1,2); c2_5 = zeros(1,2); c2_6 = zeros(1,2); c2_7 = zeros(1,2); c2_8 = zeros(1,2); c2_9 = zeros(1,2); c2_10 = zeros(1,2); c2_11 = zeros(1,2); c2_12 = zeros(1,2); c2_13 = zeros(1,2); c2_14 = zeros(1,2); c2_15 = zeros(1,2); c2_16 = zeros(1,2); c2_17 = zeros(1,2); c2_18 = zeros(1,2); c2_19 = zeros(1,2); c2_20 = zeros(1,2);
c3_1 = zeros(1,2); c3_2 = zeros(1,2); c3_3 = zeros(1,2); c3_4 = zeros(1,2); c3_5 = zeros(1,2); c3_6 = zeros(1,2); c3_7 = zeros(1,2); c3_8 = zeros(1,2); c3_9 = zeros(1,2); c3_10 = zeros(1,2); c3_11 = zeros(1,2); c3_12 = zeros(1,2); c3_13 = zeros(1,2); c3_14 = zeros(1,2); c3_15 = zeros(1,2); c3_16 = zeros(1,2); c3_17 = zeros(1,2); c3_18 = zeros(1,2); c3_19 = zeros(1,2); c3_20 = zeros(1,2);
...
for sq = 1:round(s)
        ...
        for y=1:14
            if y == 1
                for x=1:9
                    ...
                    elseif x == 3
                        if protocol == 1
                            c(y,x,z,j) = interp1(tf,O2_f*(P/(R*T_in)),t(j),'next');
                        else
                            if sq <= round(tdur/dt)
                                c(y,x,z,j) = cO2in;
                            elseif sq > round(tdur/dt)
                                c(y,x,z,j) = sol_f_next*(P/(R*T_in));
                            else
                            end
                        end
                    elseif x>3 && x<5 || x>5 && x<9
    ...
    c(:,:,:,1) = c(:,:,:,2); Pw(:,:,:,1) = Pw(:,:,:,2); Vm1(1) = Vm1(2); Vm2(1) = Vm2(2); Vm3(1) = Vm3(2); Vm4(1) = Vm4(2); Vm5(1) = Vm5(2); Vm6(1) = Vm6(2);
    c1_ch(1) = c1_ch(2); c2_ch(1) = c2_ch(2); c3_ch(1) = c3_ch(2); c4_ch(1) = c4_ch(2); c5_ch(1) = c5_ch(2); c6_ch(1) = c6_ch(2); Pw1_avg(1) = Pw1_avg(2); Pw2_avg(1) = Pw2_avg(2); Pw3_avg(1) = Pw3_avg(2); Pw4_avg(1) = Pw4_avg(2); Pw5_avg(1) = Pw5_avg(2); Pw6_avg(1) = Pw6_avg(2);
    delz1(1) = delz1(2); delz2(1) = delz2(2); delz3(1) = delz3(2); delz4(1) = delz4(2); delz5(1) = delz5(2); delz6(1) = delz6(2);
    c1_1(1) = c1_1(2); c1_2(1) = c1_2(2); c1_3(1) = c1_3(2); c1_4(1) = c1_4(2); c1_5(1) = c1_5(2); c1_6(1) = c1_6(2); c1_7(1) = c1_7(2); c1_8(1) = c1_8(2); c1_9(1) = c1_9(2); c1_10(1) = c1_10(2); c1_11(1) = c1_11(2); c1_12(1) = c1_12(2); c1_13(1) = c1_13(2); c1_14(1) = c1_14(2); c1_15(1) = c1_15(2); c1_16(1) = c1_16(2); c1_17(1) = c1_17(2); c1_18(1) = c1_18(2); c1_19(1) = c1_19(2); c1_20(1) = c1_20(2);
    c2_1(1) = c2_1(2); c2_2(1) = c2_2(2); c2_3(1) = c2_3(2); c2_4(1) = c2_4(2); c2_5(1) = c2_5(2); c2_6(1) = c2_6(2); c2_7(1) = c2_7(2); c2_8(1) = c2_8(2); c2_9(1) = c2_9(2); c2_10(1) = c2_10(2); c2_11(1) = c2_11(2); c2_12(1) = c2_12(2); c2_13(1) = c2_13(2); c2_14(1) = c2_14(2); c2_15(1) = c2_15(2); c2_16(1) = c2_16(2); c2_17(1) = c2_17(2); c2_18(1) = c2_18(2); c2_19(1) = c2_19(2); c2_20(1) = c2_20(2);
    c3_1(1) = c3_1(2); c3_2(1) = c3_2(2); c3_3(1) = c3_3(2); c3_4(1) = c3_4(2); c3_5(1) = c3_5(2); c3_6(1) = c3_6(2); c3_7(1) = c3_7(2); c3_8(1) = c3_8(2); c3_9(1) = c3_9(2); c3_10(1) = c3_10(2); c3_11(1) = c3_11(2); c3_12(1) = c3_12(2); c3_13(1) = c3_13(2); c3_14(1) = c3_14(2); c3_15(1) = c3_15(2); c3_16(1) = c3_16(2); c3_17(1) = c3_17(2); c3_18(1) = c3_18(2); c3_19(1) = c3_19(2); c3_20(1) = c3_20(2);
    c4_1(1) = c4_1(2); c4_2(1) = c4_2(2); c4_3(1) = c4_3(2); c4_4(1) = c4_4(2); c4_5(1) = c4_5(2); c4_6(1) = c4_6(2); c4_7(1) = c4_7(2); c4_8(1) = c4_8(2); c4_9(1) = c4_9(2); c4_10(1) = c4_10(2); c4_11(1) = c4_11(2); c4_12(1) = c4_12(2); c4_13(1) = c4_13(2); c4_14(1) = c4_14(2); c4_15(1) = c4_15(2); c4_16(1) = c4_16(2); c4_17(1) = c4_17(2); c4_18(1) = c4_18(2); c4_19(1) = c4_19(2); c4_20(1) = c4_20(2);
    ...
    if sq <= round(tdur/dt) && mod(sq,10) == 0 % During run duration for current segment
        counter_o = counter_o + 1;
        c_o(counter_o) = c3_20(1);
        t_o(counter_o) = t(1);
    elseif sq > round(tdur/dt) && mod(sq,10) == 0 % After run duration for current segment
        counter_a = counter_a + 1;
        c_after(counter_a) = c3_20(1);
        t_after(counter_a) = t(1);
    else
    end
end
...
c1_ch_ic = c1_ch(end); c2_ch_ic = c2_ch(end); c3_ch_ic = c3_ch(end); c4_ch_ic = c4_ch(end); c5_ch_ic = c5_ch(end); c6_ch_ic = c6_ch(end); Pw1_avg_ic = Pw1_avg(end); Pw2_avg_ic = Pw2_avg(end); Pw3_avg_ic = Pw3_avg(end); Pw4_avg_ic = Pw4_avg(end); Pw5_avg_ic = Pw5_avg(end); Pw6_avg_ic = Pw6_avg(end);
delz1_ic = delz1(end); delz2_ic = delz2(end); delz3_ic = delz3(end); delz4_ic = delz4(end); delz5_ic = delz5(end); delz6_ic = delz6(end);
c1_1_ic = c1_1(end); c1_2_ic = c1_2(end); c1_3_ic = c1_3(end); c1_4_ic = c1_4(end); c1_5_ic = c1_5(end); c1_6_ic = c1_6(end); c1_7_ic = c1_7(end); c1_8_ic = c1_8(end); c1_9_ic = c1_9(end); c1_10_ic = c1_10(end); c1_11_ic = c1_11(end); c1_12_ic = c1_12(end); c1_13_ic = c1_13(end); c1_14_ic = c1_14(end); c1_15_ic = c1_15(end); c1_16_ic = c1_16(end); c1_17_ic = c1_17(end); c1_18_ic = c1_18(end); c1_19_ic = c1_19(end); c1_20_ic = c1_20(end);
c2_1_ic = c2_1(end); c2_2_ic = c2_2(end); c2_3_ic = c2_3(end); c2_4_ic = c2_4(end); c2_5_ic = c2_5(end); c2_6_ic = c2_6(end); c2_7_ic = c2_7(end); c2_8_ic = c2_8(end); c2_9_ic = c2_9(end); c2_10_ic = c2_10(end); c2_11_ic = c2_11(end); c2_12_ic = c2_12(end); c2_13_ic = c2_13(end); c2_14_ic = c2_14(end); c2_15_ic = c2_15(end); c2_16_ic = c2_16(end); c2_17_ic = c2_17(end); c2_18_ic = c2_18(end); c2_19_ic = c2_19(end); c2_20_ic = c2_20(end);
c3_1_ic = c3_1(end); c3_2_ic = c3_2(end); c3_3_ic = c3_3(end); c3_4_ic = c3_4(end); c3_5_ic = c3_5(end); c3_6_ic = c3_6(end); c3_7_ic = c3_7(end); c3_8_ic = c3_8(end); c3_9_ic = c3_9(end); c3_10_ic = c3_10(end); c3_11_ic = c3_11(end); c3_12_ic = c3_12(end); c3_13_ic = c3_13(end); c3_14_ic = c3_14(end); c3_15_ic = c3_15(end); c3_16_ic = c3_16(end); c3_17_ic = c3_17(end); c3_18_ic = c3_18(end); c3_19_ic = c3_19(end); c3_20_ic = c3_20(end);
c4_1_ic = c4_1(end); c4_2_ic = c4_2(end); c4_3_ic = c4_3(end); c4_4_ic = c4_4(end); c4_5_ic = c4_5(end); c4_6_ic = c4_6(end); c4_7_ic = c4_7(end); c4_8_ic = c4_8(end); c4_9_ic = c4_9(end); c4_10_ic = c4_10(end); c4_11_ic = c4_11(end); c4_12_ic = c4_12(end); c4_13_ic = c4_13(end); c4_14_ic = c4_14(end); c4_15_ic = c4_15(end); c4_16_ic = c4_16(end); c4_17_ic = c4_17(end); c4_18_ic = c4_18(end); c4_19_ic = c4_19(end); c4_20_ic = c4_20(end);
c5_1_ic = c5_1(end); c5_2_ic = c5_2(end); c5_3_ic = c5_3(end); c5_4_ic = c5_4(end); c5_5_ic = c5_5(end); c5_6_ic = c5_6(end); c5_7_ic = c5_7(end); c5_8_ic = c5_8(end); c5_9_ic = c5_9(end); c5_10_ic = c5_10(end); c5_11_ic = c5_11(end); c5_12_ic = c5_12(end); c5_13_ic = c5_13(end); c5_14_ic = c5_14(end); c5_15_ic = c5_15(end); c5_16_ic = c5_16(end); c5_17_ic = c5_17(end); c5_18_ic = c5_18(end); c5_19_ic = c5_19(end); c5_20_ic = c5_20(end);
c6_1_ic = c6_1(end); c6_2_ic = c6_2(end); c6_3_ic = c6_3(end); c6_4_ic = c6_4(end); c6_5_ic = c6_5(end); c6_6_ic = c6_6(end); c6_7_ic = c6_7(end); c6_8_ic = c6_8(end); c6_9_ic = c6_9(end); c6_10_ic = c6_10(end); c6_11_ic = c6_11(end); c6_12_ic = c6_12(end); c6_13_ic = c6_13(end); c6_14_ic = c6_14(end); c6_15_ic = c6_15(end); c6_16_ic = c6_16(end); c6_17_ic = c6_17(end); c6_18_ic = c6_18(end); c6_19_ic = c6_19(end); c6_20_ic = c6_20(end);
T1_ic = T(2,2,3) - 273;

% Initial conditions stored in structure
ic = struct('c_ic',c_ic, 'Pw_ic', Pw_ic, 'Vm1_ic', Vm1_ic,'Vm2_ic', Vm2_ic, 'Vm3_ic', Vm3_ic, 'Vm4_ic', Vm4_ic, 'Vm5_ic', Vm5_ic, 'Vm6_ic', Vm6_ic, 'c1_ch_ic', ...
    c1_ch_ic, 'c2_ch_ic', c2_ch_ic, 'c3_ch_ic', c3_ch_ic, 'c4_ch_ic', c4_ch_ic, 'c5_ch_ic', c5_ch_ic, 'c6_ch_ic', c6_ch_ic, 'Pw1_avg_ic', Pw1_avg_ic, 'Pw2_avg_ic', Pw2_avg_ic, 'Pw3_avg_ic', Pw3_avg_ic, 'Pw4_avg_ic', Pw4_avg_ic, 'Pw5_avg_ic', Pw5_avg_ic, 'Pw6_avg_ic', Pw6_avg_ic, ...
    'delz1_ic', delz1_ic, 'delz2_ic', delz2_ic, 'delz3_ic', delz3_ic, 'delz4_ic', delz4_ic, 'delz5_ic', delz5_ic, 'delz6_ic', delz6_ic, ...
    'c1_1_ic', c1_1_ic, 'c1_2_ic', c1_2_ic, 'c1_3_ic', c1_3_ic, 'c1_4_ic', c1_4_ic, 'c1_5_ic', c1_5_ic, 'c1_6_ic', c1_6_ic, 'c1_7_ic', c1_7_ic, 'c1_8_ic', c1_8_ic, 'c1_9_ic', c1_9_ic, 'c1_10_ic', c1_10_ic, 'c1_11_ic', c1_11_ic, 'c1_12_ic', c1_12_ic, 'c1_13_ic', c1_13_ic, 'c1_14_ic', c1_14_ic, 'c1_15_ic', c1_15_ic, 'c1_16_ic', c1_16_ic, 'c1_17_ic', c1_17_ic, 'c1_18_ic', c1_18_ic, 'c1_19_ic', c1_19_ic, 'c1_20_ic', c1_20_ic, ...
    'c2_1_ic', c2_1_ic, 'c2_2_ic', c2_2_ic, 'c2_3_ic', c2_3_ic, 'c2_4_ic', c2_4_ic, 'c2_5_ic', c2_5_ic, 'c2_6_ic', c2_6_ic, 'c2_7_ic', c2_7_ic, 'c2_8_ic', c2_8_ic, 'c2_9_ic', c2_9_ic, 'c2_10_ic', c2_10_ic, 'c2_11_ic', c2_11_ic, 'c2_12_ic', c2_12_ic, 'c2_13_ic', c2_13_ic, 'c2_14_ic', c2_14_ic, 'c2_15_ic', c2_15_ic, 'c2_16_ic', c2_16_ic, 'c2_17_ic', c2_17_ic, 'c2_18_ic', c2_18_ic, 'c2_19_ic', c2_19_ic, 'c2_20_ic', c2_20_ic, ...
    'c3_1_ic', c3_1_ic, 'c3_2_ic', c3_2_ic, 'c3_3_ic', c3_3_ic, 'c3_4_ic', c3_4_ic, 'c3_5_ic', c3_5_ic, 'c3_6_ic', c3_6_ic, 'c3_7_ic', c3_7_ic, 'c3_8_ic', c3_8_ic, 'c3_9_ic', c3_9_ic, 'c3_10_ic', c3_10_ic, 'c3_11_ic', c3_11_ic, 'c3_12_ic', c3_12_ic, 'c3_13_ic', c3_13_ic, 'c3_14_ic', c3_14_ic, 'c3_15_ic', c3_15_ic, 'c3_16_ic', c3_16_ic, 'c3_17_ic', c3_17_ic, 'c3_18_ic', c3_18_ic, 'c3_19_ic', c3_19_ic, 'c3_20_ic', c3_20_ic, ...
    'c4_1_ic', c4_1_ic, 'c4_2_ic', c4_2_ic, 'c4_3_ic', c4_3_ic, 'c4_4_ic', c4_4_ic, 'c4_5_ic', c4_5_ic, 'c4_6_ic', c4_6_ic, 'c4_7_ic', c4_7_ic, 'c4_8_ic', c4_8_ic, 'c4_9_ic', c4_9_ic, 'c4_10_ic', c4_10_ic, 'c4_11_ic', c4_11_ic, 'c4_12_ic', c4_12_ic, 'c4_13_ic', c4_13_ic, 'c4_14_ic', c4_14_ic, 'c4_15_ic', c4_15_ic, 'c4_16_ic', c4_16_ic, 'c4_17_ic', c4_17_ic, 'c4_18_ic', c4_18_ic, 'c4_19_ic', c4_19_ic, 'c4_20_ic', c4_20_ic, ...
...
c_all = [c_o c_after]; % Dissolved oxygen profile at Well 3 cell layer for total run time
t_all = [t_o t_after]; % Time vector for total run time

diff_c = diff(c_all)/(t_all(2)-t_all(1)); % Derivative of dissolved oxygen profile to determine inflection points
indices = find([0 diff(sign(diff_c))]~=0); % Find inflection points
no_inflection = length(indices); % Number of inflection points


if toggle == 1  % For optimization (objective function evaluation)
        if no_inflection > 1 
            f(1) = abs(target_t-(t_all(indices(end))-t_all(indices(end-1))));
            f(2) = abs(target-c_all(indices(end))*1e9);
            f(3) = abs(c_all(indices(end-1))*1e9-target_prev);
        else
            f(1) = 100; % Placeholder value to disregard possible solution set
            f(2) = 100; % Placeholder value to disregard possible solution set
            f(3) = 100; % Placeholder value to disregard possible solution set
        end
